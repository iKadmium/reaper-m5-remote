 ...
 *LV_DITHER_GRADIENT implies LV_GRADIENT_MAX_STOPS = 256 (the number of possible intermediary colors)
 *LV_DITHER_ERROR_DIFFUSION can be used to try to minimize the error caused by dithering*/
 ...
 *If LV_USE_ASSERT_NULL is enabled an error message will be printed on NULL pointer dereference too.*/
...
#define LV_USE_LIST 1 /*Requires: lv_btn, lv_label, (lv_page)*/
#define LV_USE_METER 1
#define LV_USE_MSGBOX 1  /*Requires: lv_btnmatrix, lv_label*/
#define LV_USE_ROLLER 1  /*Requires: lv_label*/
#define LV_USE_SLIDER 1  /*Requires: lv_bar*/
#define LV_USE_SPAN 1    /*Requires: lv_label*/
#define LV_USE_SPINBOX 1 /*Requires: lv_textarea*/
#define LV_USE_SPINNER 1 /*Requires: lv_arc, lv_anim*/
#define LV_USE_SWITCH 1
#define LV_USE_TEXTAREA 1 /*Requires: lv_label*/
#define LV_USE_TABLE 1    /*Requires: lv_label*/
#define LV_USE_TABVIEW 1  /*Requires: lv_btn, lv_btnmatrix, lv_page*/
#define LV_USE_TILEVIEW 1 /*Requires: lv_page*/
#define LV_USE_WIN 1      /*Requires: lv_btn, lv_label, lv_img, lv_page*/
